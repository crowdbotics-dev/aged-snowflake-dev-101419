"""
Django settings for aged_snowflake_dev_101419 project.
...
ROOT_URLCONF = 'aged_snowflake_dev_101419.urls'
...
WSGI_APPLICATION = 'aged_snowflake_dev_101419.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_snowflake_dev_101419 API",
    "DESCRIPTION": "API documentation for aged_snowflake_dev_101419 App",
    "VERSION": "v1",
}
