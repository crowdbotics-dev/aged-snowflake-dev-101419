...
## Project Structure
    ...
    ├── aged_snowflake_dev_101419  # Django project configurations
...
1. Clone this repo and `cd aged_snowflake_dev_101419`
...
2. Clone this repo and `cd aged_snowflake_dev_101419`
